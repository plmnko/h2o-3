...
class Test_rf_grid_search:
    ...
    training1_filename = "gridsearch_rf_training1_"+curr_time+"_set.csv"
            ...
            if not (self.correct_model_number == self.possible_number_models):  # wrong grid model number
                ...
                for each_model in grid_model:
                    ...
                    if (each_model_runtime > 0) and \
                        ...
                        print("test_rf_grid_search_over_params for random forest failed: grid search model and manually "
